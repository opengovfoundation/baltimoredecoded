...
<h2>Data Sources</h2>
<p>Data Sources
The information that makes up Baltimore Charter Decoded comes entirely from public sources. All of the sections of the code are straight from the <a href="http://www.baltimorecity.gov/">Baltimore Department of Legislative Services</a>, who provided XML of the Charter. Any further included legislative data is scraped from the Baltimore State Legislature website. Term definitions, where included, are from within the state charter itself. Throughout the site, links are provided to original data sources, whenever possible. <a href="http://www.baltimorecity.gov/">Click here to visit the Baltimore Legislative Services Department presentation of the Baltimore Charter.</a></p>
<h2>API</h2>
<p>The site has a RESTful, JSON-based API. <a href="http://charter.baltimorecode.org/api-key/">Register for an API key</a> and <a href="https://github.com/statedecoded/statedecoded/wiki/API-Documentation">read the documentation</a> for details.</p>
<h2>Thanks</h2>
<p>Baltimore Charter Decoded wouldn’t be possible without the contributions and years of work by <a href="http://waldo.jaquith.org/">Waldo Jaquith</a>, and the many dozens of people who participated in private alpha and beta testing of <a href="http://vacode.org/about/">Virginia Decoded</a>, the first <a href="http://www.statedecoded.com/">State Decoded</a> site, over the course of a year and a half, beginning in 2010. Specific thanks must be extended the good people of the Baltimore Department of Legislative Services. This platform on which this site is based, <a href="http://www.statedecoded.com/">The State Decoded</a>, was expanded to function beyond Virginia thanks to a generous grant by the <a href="http://knightfoundation.org/">John S. and James L. Knight Foundation</a>.</p>
<h2>Colophon</h2>
